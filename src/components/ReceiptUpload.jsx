    ...
    <div className="max-w-2xl mx-auto px-4 py-6 sm:py-8">
        ...
        {imageUrl ? (
          <div className="p-4">
            <img
              src={imageUrl}
              alt="Receipt preview"
              className="max-h-64 sm:max-h-72 mx-auto rounded-xl object-contain shadow-sm"
            />
            <button
              onClick={(e) => {
                e.stopPropagation();
              ...
              className="absolute top-3 right-3 bg-white rounded-full p-2 shadow text-gray-500 hover:text-red-500 transition-colors min-w-[36px] min-h-[36px] flex items-center justify-center"
            >
          ...
          <div className="py-12 sm:py-14 px-6 text-center">
            ...
            <p className="text-gray-400 text-sm mt-1">or tap to take a photo / browse</p>
      ...
      <div className="mt-4 flex flex-col gap-3">
        <button
          ...
          className="w-full py-3.5 bg-green-500 hover:bg-green-600 disabled:bg-gray-200 disabled:text-gray-400 text-white font-semibold rounded-xl transition-all active:scale-95 text-base"
        >
        ...
        <button
          ...
          className="w-full py-3.5 bg-white hover:bg-gray-50 text-gray-600 font-medium rounded-xl border border-gray-200 transition-all active:scale-95 text-base"
        >
      ...
      {rawText && (
        <details className="mt-4">
          ...
          <pre className="mt-2 text-xs text-gray-400 bg-gray-50 p-3 rounded-lg overflow-x-auto whitespace-pre-wrap break-words">
            {rawText}
          </pre>
        </details>
      )}
